...
<!-- HTML -->
<section>
    <Card titleSpanish="Meses" titleEnglish="Months">
        <WordGuesser words={months}></WordGuesser>
    </Card>
    
    <Card titleSpanish="Colores" titleEnglish="Colors">
        <WordGuesser words={colors}></WordGuesser></Card>
